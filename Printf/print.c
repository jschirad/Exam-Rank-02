...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/13 14:56:24 by jschirad          #+#    #+#             */
/*   Updated: 2020/02/17 19:38:10 by jschirad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	int i = printf("jaja%30.10s %.3s %.30s %20s %30.10d %30d %.10d %30.10d %5.0d %30.10x %30x %.10x %30.10x %5.0x\n", "jaime que", "jaime", "jaime", "jaime", 30, 30 , 303030, -303030, 0, 30, 30 , 303030, -303030, 0);
	int j = ft_printf("jaja%30.10s %.3s %.30s %20s %30.10d %30d %.10d %30.10d %5.0d %30.10x %30x %.10x %30.10x %5.0x\n", "jaime que", "jaime", "jaime", "jaime", 30, 30 , 303030, -303030, 0, 30, 30 , 303030, -303030, 0);
	printf("\n%6.30s\n", "jaime");
	ft_printf("\n%6.30s", "jaime");
	printf("%d\n", i);
	printf("%d\n", j);
